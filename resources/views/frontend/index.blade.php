        ...
        <div class="row no-gutters slider-text justify-content-center align-items-center">
          <div class="col-lg-8 col-md-6 ftco-animate d-flex align-items-end">
          	<div class="text text-center w-100">
	            <h1 class="mb-4">Khoa tự  <br>thay đổi</h1>
        ...
        <div class="row">
        	<div class="col-md-4">
        		<div class="property-wrap ftco-animate">
        			...
        			<div class="text">
        				<p class="price mb-3"><span class="orig-price">12 TỶ</span></p>
        				<h3 class="mb-0"><a href="properties-single.html">CĂN HỘ CAO CẤP OCEAN PARK</a></h3>
        				...
        				<ul class="property_list">
        					...
        					<li><span class="flaticon-floor-plan"></span>100m2</li>
        				</ul>
        			</div>
        		</div>
        	</div>
    ...
    <section class="ftco-section ftco-fullwidth">
    	...
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate mb-5">
            ...
            <h2 class="mb-2">TẠI SAO LẠI CHỌN CHÚNG TÔI</h2>
          </div>
        </div>
    	</div>
